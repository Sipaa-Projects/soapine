...
of either a `/limine.cfg`, `/limine/limine.cfg`, `/boot/limine.cfg`, `/boot/limine/limine.cfg`, `/EFI/BOOT/limine.cfg`, `/soapine.cfg`, `/soapine/soapine.cfg`, `/boot/soapine.cfg`, `/boot/soapine/soapine.cfg`, 
or a `/EFI/BOOT/soapine.cfg` file, in that order.
