...
static void console_help(void) {
    print(
        ...
        "newmenu   -- Shows up Soapine's new menu.\n"
        "%s"
...
void console(void) {
    print("Welcome to the Soapine console.\nType 'help' for more information.\n\n");
    ...
    for (;;) {
        ...
        if (strcmp(prompt, "help") == 0) {
            ...
            print("Soapine & Limine are distributed under the terms of the BSD-2-Clause license.\n");
